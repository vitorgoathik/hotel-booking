  ...
  return (
    <>
      ...
      <section className="bg-gradient-to-br from-amber-700 via-amber-600 to-orange-600 pb-16 pt-12">
        <div className="mx-auto max-w-5xl px-4">
          ...
          <div className="flex items-center gap-4 mb-6">
            ...
            <div>
              <h1 className="text-3xl font-extrabold text-white sm:text-4xl">Hotels in {dest.city}</h1>
        ...
        <div className="mx-auto max-w-5xl px-4 py-6">
          <dl className="grid grid-cols-2 gap-4 sm:grid-cols-4">
            <div className="text-center">
              <dt className="text-2xl font-extrabold text-amber-600"><Price usd={minPrice} /></dt>
      ...
      <div className="mx-auto max-w-7xl px-4 py-10">
        <h2 className="mb-6 text-xl font-bold text-slate-900">Available Hotels in {dest.city}</h2>
        <SearchResults
          hotels={hotels}
        ...
        <div className="grid grid-cols-2 gap-3 sm:grid-cols-4">
          {relatedDestinations.map((d) => (
            ...
            >
              ...
              <p className="mt-1 text-sm font-medium text-slate-800 group-hover:text-amber-600 transition-colors">{d.city}</p>
              <p className="text-xs text-slate-400">from <Price usd={d.minPrice} />/night</p>
            </Link>
          ))}
        </div>
      </section>
